...
const (
	Warehouse_ReserveStock_FullMethodName = "/warehouse.Warehouse/ReserveStock"
)
...
func (c *warehouseClient) ReserveStock(ctx context.Context, in *ReserveStockRequest, opts ...grpc.CallOption) (*ReserveStockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReserveStockResponse)
	err := c.cc.Invoke(ctx, Warehouse_ReserveStock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWarehouseServer) ReserveStock(context.Context, *ReserveStockRequest) (*ReserveStockResponse, error) {
...
func _Warehouse_ReserveStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReserveStockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WarehouseServer).ReserveStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Warehouse_ReserveStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WarehouseServer).ReserveStock(ctx, req.(*ReserveStockRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Warehouse_ReserveStock_Handler,
		},
	},
